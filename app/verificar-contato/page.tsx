...
export default function VerificarContatoPage() {
  ...
  return (
    <div className="min-h-screen bg-[#ffffff] relative">
      {/* Header */}
      <header className="border-b border-[#d9d9d9] bg-[#ffffff] relative z-10">
        {/* Top Header */}
        ...
        <div className="bg-[#f9f9f9]">
          ...
          <footer className="bg-[#002d4b] text-white">
            <div className="max-w-7xl mx-auto px-4 py-12">
              ...
              <hr className="border-[#135b9e] mb-8" />
      ...
      <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
        <div className="bg-white rounded-lg p-8 max-w-md w-full mx-4 shadow-xl">
          <h2 className="text-xl font-semibold text-[#002d4b] mb-4">Verificar dados de contato</h2>
