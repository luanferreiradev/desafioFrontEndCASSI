...
import { Facebook, Linkedin, Instagram, AlertTriangle, CheckCircle, ChevronDown } from "lucide-react"
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
            ...
            <div className="lg:col-span-2">
              ...
              <div className="bg-[#f9f9f9] p-6 rounded-lg mb-6">
                ...
                {/* Warning Banner */}
                <div className="bg-[#fbd0d4] border border-[#ec1529] rounded-lg p-4 mb-4 flex items-center gap-3">
                  <AlertTriangle className="w-5 h-5 text-[#ec1529]" />
                  <span className="text-[#2d2d2d] font-medium">
                    Interlocutor <strong>RECONHECIDO</strong> e abertura da NIP <strong>NÃO RECONHECIDA</strong> pelo
                    usuário.
                  </span>
                </div>
                ...
                <div className="flex items-center gap-2">
                  ...
                  <span className="text-[#29bb11] font-medium">Obrigado pela resposta!</span>
                </div>
              </div>
            </div>
